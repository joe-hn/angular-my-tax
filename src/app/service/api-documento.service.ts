...
export class ApiDocumentoService {
  ...
  constructor(
    ...
    this.url = _global.url + 'documento/';
  }
  ...
  GetCompra(compra): Observable<any> {
    return this.http.get(this.url + 'compra/procesar/' + compra, this.httpOptions).pipe(map(this.extractData));
  }
