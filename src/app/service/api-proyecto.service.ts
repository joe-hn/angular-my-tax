...
export class ApiProyectoService {
  ...
  GetClienteTipoProyecto(cliente, tipoProyecto): Observable<any> {    
    return this.http.get(this.url + cliente + '/' + tipoProyecto, this.httpOptions).pipe(map(this.extractData));
  }
